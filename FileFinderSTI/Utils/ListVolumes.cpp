      ...
      if (Names) {
         ...
         if (strlen(Names)) {
            for (char* NameIdx = Names; NameIdx[0]; NameIdx += strlen(NameIdx) + 1) {
               ...
               strcpy_s<MAX_PATH>(volumes[volumes_count].PathName, NameIdx);
               ...
               strcpy_s<MAX_PATH>(volumes[volumes_count].VolumeName, VolumeName);
               strcpy_s<MAX_PATH>(volumes[volumes_count].DeviceName, DeviceName);
               volumes_count++;
            }
         } else {
